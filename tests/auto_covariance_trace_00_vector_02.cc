...
//
// This test is the same as the auto_covariance_trace_01 test, but
// instead of scalar-valued samples, it uses vectors of size 2 for
// which the first component is simply always zero and the second
// component as in the original test
