...
// intervals at [-0.5,0.5], [0.5,1.5], [1.5,2.5], i.e., we do not have
// to worry about hitting any of the end points.
...
int main ()
{
  ...
  SampleFlow::Consumers::Histogram<SampleType> histogram(-0.5, 2.5, 3);
