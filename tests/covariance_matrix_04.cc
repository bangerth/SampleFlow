...
// This test generates a sequence of complex-typed real numbers
...
// imaginary component in this sequence is 0, so the variance of the sequence
// overall is 6+0=6.
...
int main ()
{
  ...
  // The samples are the numbers [1 + 0i, 2 + 0i, 3 + 0i, 4 + 0i, 5 + 0i, 6 + 0i, 7 + 0i, 8 + 0i] so
